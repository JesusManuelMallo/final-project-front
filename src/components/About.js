...
export default function About() {
    return (
        ...
        <h1>JESUS MALLO BIO</h1>
          <div className="bioData">
            <p className="bioDataSmall">
            <h2>Born:</h2><h3> 1986, Barcelona(Spain)</h3>
              </p>
              <br/>
              <p className="bioDataSmall">
            <h2>Lived in:</h2><h3> (Spain) Barcelona, Vic, Hospitalet, Aiguafreda, Tona </h3>
              </p>
              <br/>
              <p className="bioDataSmall">
            <h2>Travelled to:</h2><h3>Israel, Slovakia, France, Portugal, Switzerland, Andorra, Italy</h3>
              </p>

          </div>
<br/>
<hr/>
<h2>The beginnings: 2002</h2>
<p className="bioDataSmall"><h3>Jesus Mallo started composing music when 16 years old by 2002, 
when he composed his first classical music piece: a piano sonata. By then, Queen, Prince, Michael Jackson and Jamiroquai, were his main influences,
a part from Mozart and Bach</h3></p>
<hr/>
<h2>Music Bands: 2008-2010</h2>
